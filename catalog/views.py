...
class BookListView(generic.ListView):
    ...
    model = Book
    paginate_by = 3
    template_name = "catalog/fixed-index2.html"
    # template_name = "catalog/fixed-student-course.html"
...
class BookDetailView(generic.DetailView):
    ...
    #     obj = get_object_or_404(Book, ebookid=ebook_id)
    #     if obj is not None:
